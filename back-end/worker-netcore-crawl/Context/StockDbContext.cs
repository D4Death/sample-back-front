...
using worker_netcore_crawl.Entity;

namespace worker_netcore_crawl.Context
{
    public class StockDbContext : DbContext
    {
        ...
        //{
        //    optionsBuilder.UseNpgsql(Configuration.GetConnectionString("HostConnection")), ServiceLifetime.Singleton);
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //{
            //    entity.Property(m => m.Id).ValueGeneratedOnAdd(); //.HasKey(m => m.Id);
            ...
            //modelBuilder.Entity<BinanceTradingMessage>(entity => {
            //    entity.HasKey(m => m.TradeId);
            //    entity.Property(m => m.Symbol);
            //    entity.Property(m => m.BuyerOrderId);
            //    entity.Property(m => m.SellerOrderId);
            //    entity.Property(m => m.EventType);
            //    entity.Property(m => m.EventUnixTime);
            //    entity.Property(m => m.TradeUnixTime);
            //    entity.Property(m => m.Price);
            //    entity.Property(m => m.Quantity);
            //    entity.Property(m => m.IsBuyerMarketMaker);
            //    entity.Property(m => m.Ignore);
            //});
        ...
        //public DbSet<IntraDayMessage> IntraDayMessages { get; set; }
        //public DbSet<BinanceTradingMessage> BinanceTradingMessages { get; set; }
